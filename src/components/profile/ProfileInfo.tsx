            ...
            <div className=" flex flex-wrap lg:flex-col items-center justify-center gap-4 md:gap-8 lg:gap-4 w-full sm:w-[90%] py-10">
                        ...
                        <div className=" flex flex-wrap md:flex-row items-center justify-center gap-4 2xl:gap-6 min-h-[20%]">
                            {profileInfo.rol==Roles.escritor?
                                <p className='text-lg font-sans flex flex-col text-center hover:text-blue-500 cursor-pointer' title="View user writings" onClick={()=>{setArticlesPage([userInfo.rol==Roles.lector?articlesPage[0]:!articlesPage[0], false, false]);setFollow([false,false])}}>{articlesPage[0]? 'Your':profileInfo.articlesByUser?.length}  <a>{articlesPage[0]?'Saves':'Articles'}</a></p>
                            :
                                <p className='text-lg font-sans flex flex-col text-center hover:text-blue-500 cursor-pointer' title="View user saved articles" onClick={()=>{setArticlesPage([!articlesPage[0], false]);setFollow([false,false])}}>{userView==userInfo.userId?"Your":"Writer"}<a>Articles</a></p>
                            }
                            ...
                            <p id = "2" title="View user followers" className='text-lg font-sans flex flex-col text-center hover:text-blue-500 cursor-pointer ' onClick={()=>{setFollow([false,false]);setArticlesPage([articlesPage[0], !articlesPage[1], false])}}>Attended <a>Events</a></p>
                            <p id = "2" title="View user followers" className='text-lg font-sans flex flex-col text-center hover:text-blue-500 cursor-pointer ' onClick={()=>{setFollow([false,false]);setArticlesPage([articlesPage[0], false, !articlesPage[2]])}}>{userView==userInfo.userId?"My":"Followed"} <a>Comunitties</a></p>
                        </div>
