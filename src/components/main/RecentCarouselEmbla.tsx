...
import RecentCarouselDots from "./RecentCarouselDots";
import React from 'react'
import RecentCarouselControls from "./RecentCarouselControls";
// Define the props
type Props = PropsWithChildren & EmblaOptionsType;

const RecentCarouselEmbla = ({ children, ...options }: Props) => {
...
export default RecentCarouselEmbla;
