...
const SignUpCard=()=>{
    ...
    return <>
        <div id = "login-container" className="shadow-2xl bg-white rounded-[17px] h-[95%] sm:-[90%] md:h-4/5  w-[71%] md:w-[65%] lg:w-[60%] xl:w-1/2   grid place-items-center py-0 sm:py-3 ">
